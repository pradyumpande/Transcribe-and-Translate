...
export default function Information(props) {
   ...
   return (
     <main className='flex-1 p-4 flex flex-col gap-3 text-center sm:gap-4  justify-center pb-20  max-w-prose w-full mx-auto'>
        <h1 className='font-semibold text-4xl sm:text-5xl  md-text-6xl whitespace-nowrap'>Your <span className='text-blue-400 bold '>Transcriptions</span></h1>
        <div className="grid grid-cols-2 mx-auto bg-white shadow rounded-full overflow-hidden items-center ">
            ...
            <button onClick={()=> setTab('translation')} className={'px-4 duration-200 py-1  '+ (tab === 'translation' ? ' bg-blue-400 text-white':'text-blue-400 hover:text-blue-600')}>Translation</button>
        </div>
           ...
           {(!finished || translating) && (
            ...
            {tab === 'transcription' ? (
                <Transcription {...props} textElement ={textElement} />
                   ...
                   <Translation {...props} toLanguage={toLanguage}
                       translating={translating} translation={translation}
            ...
            <div className="flex items-center gap-4 mx-auto ">
                ...
                <button onClick={handleDownload} title="Download" className='bg-white  hover:text-blue-500 duration-200 text-blue-300 px-2 aspect-square grid place-items-center rounded px-4'>
