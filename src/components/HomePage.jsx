...
export default function HomePage(props) {
    ...
    <main className='flex-1 p-4 flex flex-col gap=3 text-center sm:gap-4 justify-center pb-20'>
      <h1 className='font-semibold text-5xl md:text-7xl'>FreeTranslate/<span className='text-blue-400 bold '>FreeTranscribe</span></h1>
      ...
      <button onClick={recordingStatus === 'recording'? stopRecording : startRecording} className='flex specialBtn px-4 py-2 rounded-xl  items-center text-base justify-between gap-4 mx-auto w-80 my-4'>
      ...
      <p className='text-base'>Or <label className='text-blue-400 cursor-pointer hover:text-blue-600 duration-200'>upload <input onChange={(e)=>{
        ...
        setFile(tempFile)
          ...
          mp3 file</p>
          <p className='italic text-slate-400'>made by Pradhumn Pande...</p>
     </main>
    )
}